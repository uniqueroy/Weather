...
#import "WNetworkUtilWithIndicator.h"
#import "JSONKit.h"

@implementation WNetworkUtilWithIndicator
@synthesize visible;
...
-(id)initWithFrame:(CGRect)frame superView:(UIView*)superView{
    ...
    if (self) {
        ...
        indicator.frame=CGRectMake(3*gridUnit, 2*gridUnit, ind_width, ind_width);
...
-(void)alignToCenter{
    ...
    CGPoint centerSelf={self.frame.origin.x+self.frame.size.width/2, self.frame.origin.y+self.frame.size.height/2};
